...
class WhatsAppSession(Base):
    ...
    # REMOVED: current_question_index - duplicate state tracking eliminated
    # Session now only tracks transport/connection state
    # Progress state is owned by Briefing.information_state
