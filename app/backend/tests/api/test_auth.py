...
async def test_register_duplicate_email(client: AsyncClient) -> None:
    ...
    test_architect = await ArchitectFactory.create_async()
...
@pytest.mark.asyncio
async def test_get_current_architect(client: AsyncClient) -> None:
    """Authenticated architect info should be returned."""
    test_architect = await ArchitectFactory.create_async()
    auth_headers = make_auth_headers(test_architect)
...
@pytest.mark.asyncio
async def test_refresh_token_with_invalid_session(client: AsyncClient) -> None:
