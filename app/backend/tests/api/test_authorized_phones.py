...
async def test_list_authorized_phones(
    ...
    phone1 = await AuthorizedPhoneFactory.create_async(
        organization_id=test_organization.id,
        phone_number="+5511111111111",
        added_by_architect_id=test_architect.id,
        is_active=True,
    )
    phone2 = await AuthorizedPhoneFactory.create_async(
        organization_id=test_organization.id,
...
async def test_add_authorized_phone_duplicate_fails(
    ...
    phone = await AuthorizedPhoneFactory.create_async(
        organization_id=test_organization.id,
...
async def test_cannot_delete_phone_from_another_org(
    ...
    other_org = await OrganizationFactory.create_async(name="Other Org")

    other_phone = await AuthorizedPhoneFactory.create_async(
