...
from tests.factories import BriefingTemplateFactory, EndClientFactory


@pytest.fixture
async def test_templates(db_session: AsyncSession, test_project_type):
    ...
    for category, questions in categories.items():
        ...
        templates[category] = result.scalar_one()
...
async def existing_client(
    ...
    return await EndClientFactory.create_async(
        organization=test_organization_with_whatsapp,
        architect=test_architect_with_whatsapp,
